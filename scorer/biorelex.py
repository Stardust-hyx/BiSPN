...
def evaluate_biorelex(truth_sentences, pred_sentences, keys):
    ...
    m_score = mentions_score.get_scores()
    relex_all_score = relex_all_score.get_scores()
    print('Entity Precison = {}, Recall = {}, F1 = {}'.format(m_score['precision'], m_score['recall'], m_score['f_score']))
    print('Triple Precison = {}, Recall = {}, F1 = {}'.format(relex_all_score['precision'], relex_all_score['recall'], relex_all_score['f_score']))
    return {'f1': m_score['f_score'] * 0.5 + relex_all_score['f_score'] * 0.5}
